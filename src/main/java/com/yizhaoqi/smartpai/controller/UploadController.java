...
public class UploadController {
     ...
     */
    @Autowired
    private UploadService uploadService; // 文件上传服务

    @Autowired
    private KafkaTemplate<String, Object> kafkaTemplate; // Kafka消息模板

    @Autowired
    private KafkaConfig kafkaConfig; // Kafka配置

    @Autowired
    private UserService userService; // 用户服务
    
    @Autowired
    private FileUploadRepository fileUploadRepository; // 文件上传记录数据访问层
    
    @Autowired
    private FileTypeValidationService fileTypeValidationService; // 文件类型验证服务
    
    @Autowired
    private ChatHandler chatHandler; // 聊天处理服务，用于测试CompletableFuture示例
