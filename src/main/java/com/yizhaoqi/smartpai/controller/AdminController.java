    ...
    public ResponseEntity<?> getAllConversations(
        ...
        try {
            ...
            if (userid != null && !userid.isEmpty()) {
                ...
                if (targetUser.isPresent()) {
                    if (startDateTime != null && endDateTime != null) {
                        conversations = conversationRepository.findByUserIdAndTimestampBetween(userIdLong, startDateTime, endDateTime);
                    } else {
                        conversations = conversationRepository.findByUserId(userIdLong);
                    }
                } else {
            ...
            for (Conversation conversation : conversations) {
                ...
                allConversations.add(userMessage);
                ...
                assistantMessage.put("username", conversation.getUser().getUsername());
                allConversations.add(assistantMessage);
            }
