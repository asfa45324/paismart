        ...
        try {
            ...
            http.csrf(csrf -> csrf.disable())
                    ...
                    .authorizeHttpRequests(authorize -> authorize
                            ...
                            .requestMatchers("/api/v1/upload/**", "/api/v1/parse", "/api/v1/documents/download", "/api/v1/documents/preview", "/api/v1/documents/accessible", "/api/v1/documents/uploads").hasAnyRole("USER", "ADMIN")
